      ...
      {assignments
        ...
        <ListGroup className="wd-assignment-details rounded-0" style={{ borderLeft: '3px solid green' }} >
          ...
          <ListGroup.Item className="wd-assignment-detail p-3 ps-1 d-flex">
            ...
            <div >
              <p className="mb-0 fs-5 fw-bold">{assignment.a_name}</p>
              <p className="mb-0 fs-6 text-muted">
                <span className="text-danger ">Multiple Modules </span>
                <span> | </span> 
                <span className="fw-bold"> Not available until </span>
                <span className="">
                  {assignment.available_date!=="" ? assignment.available_date + "at" + assignment.available_time : "not released yet"}  |
                </span> <br />
                <span className="fw-bold"> Due </span>
                <span> 
                  {assignment.due_date!=="" ? assignment.due_date + "at" + assignment.due_date : "not released yet"} | 
